...
- [ ] **Run comparison tooling** — results carry the model name, but nothing diffs two runs (model A vs B, prompt v1 vs v2), which is the main thing an eval harness exists for
